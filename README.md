...
**Institution**: De Vinci Higher Education - Social Engineering </br>
**TD Group**: OCC1 </br>
...
## Project Overview : **Bias Analysis Version**
...
In this specific version, LLMs models uses specially crafted prompts to analyse messages from an user and dissect the potential biases it contains.

The biases identified are the following : 
...
Aditionnaly to the basic generative AI project, prompts has been completed in the `backedn/config.py` file, to handle bias analysis.

- Aditional prompt injection for Stage 1 :
...
- Aditional prompt injection for Stage 3 : 
...
![Demo Individual](docs/demo-individual.png)

> Bias Analysis Version :
> ![Bias Individual](docs/bias-individual.png)
...
> Bias Analysis Version :
> ![Bias Ranking](docs/bias-peer-ranking.png)
...
> Bias Analysis Version :
> ![Bias Final](docs/bias-final-ranking.png)
